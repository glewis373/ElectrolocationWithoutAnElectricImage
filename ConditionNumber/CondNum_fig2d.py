...
param1 = np.linspace(-1.0,1.0,401)
param2 = np.linspace(-1.0,1.0,401)
...
plt.xlabel('$E^{(1)}_x$',fontsize=18)
plt.ylabel('$E^{(2)}_x$',fontsize=18)


filename=f'CondNum_RandGrid_EvE.pdf'
